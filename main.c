...
int main(){
    float  fin ,linux , dev , math , win , ar , fr , eeje , com ,result , somme , module1 , module2 , module3 ;
   ...
   printf("user registred successfully !");
    ...
    module2 = (ar + fr + com + eeje) / 4;
    module3 = (dev + win) /2;
    result = (linux * 5) + (dev * 5) + (math * 3) + (win * 5) + (ar * 2) + (fr * 2) +(eeje * 3) + (com * 2) ;
    fin = result / somme;
    printf("|               | la note final est : %.2f  |                             |\n" , fin);
    if (fin < 10 || linux < 6 || dev < 6 || math < 6 || win < 6 || ar < 6 || fr < 6 || eeje < 6 || com < 6  || module1 < 10 || module2 < 10 || module3 < 10){
    ...
    if (10<fin && fin<=12 && linux > 6 && dev > 6 && math > 6 && win > 6 && ar > 6 && fr > 6 && eeje > 6 && com > 6  && module1 > 10 && module2 > 10 && module3 > 10){
        printf("|                       niveau passable                                    |\n");
    }
    else if (12<fin && fin <=14 && linux > 6 && dev > 6 && math > 6 && win > 6 && ar > 6 && fr > 6 && eeje > 6 && com > 6  && module1 > 10 && module2 > 10 && module3 > 10){
        printf("|                       niveau assez bien                                  |\n");
    }
    else if (14<fin && fin<=16 && linux > 6 && dev > 6 && math > 6 && win > 6 && ar > 6 && fr > 6 && eeje > 6 && com > 6  && module1 > 10 && module2 > 10 && module3 > 10){
        printf("|                       niveau bien                                        |\n");
    }
    else if (16<fin && fin<=20 && linux > 6 && dev > 6 && math > 6 && win > 6 && ar > 6 && fr > 6 && eeje > 6 && com > 6  && module1 > 10 && module2 > 10 && module3 > 10){
